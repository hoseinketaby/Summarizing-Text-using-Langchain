...
# Note: this block only runs locally (`python app.py`).
# On Vercel, the platform imports the `app` object directly and never
# executes this block, so no port/host config is needed for deployment.
